...
public class RazerSoundSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.razer_sound_settings);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        RazerSoundSettings getOwner() {
            return (RazerSoundSettings) getTargetFragment();
        }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            sir.xmlResId = R.xml.razer_sound_settings;
            result.add(sir);
