...
package com.android.settings.razer;
 ...
 * <li>table - refers to which table the setting key/value are referenced in. Currently only "system" is supported. Note that there is no namespace on this attribute.
 * </ul>
 * <p/>
...
public class BaseSetting extends LinearLayout {
    ...
    /**
     * @return the table which the setting will be saved to. Currently only 'system' is supported
     */
